...
def render_bubble_svg(df, width=1800, height=800, canvas_boundary_buffer=50, focus_data=None,
    ...
    svg_content = [
        ...
        '  /* :hover transform removed - handled by JS mouseenter/mouseleave in app.py */',
        '  /* Chrome 143+ (Mar 2026) broke CSS :hover transforms on SVG <g> in srcdoc iframes */',
    ...
    for _, row in df.iterrows():
        ...
        # NOTE: onmouseenter="this.parentNode.appendChild(this)" was removed here.
        # In Chrome 121+ (Jan 2024), re-appending an SVG element on mouseenter
        # causes the browser to drop the CSS :hover state immediately, making
        # hover appear completely broken. Bring-to-front is now handled by the
        # JS mouseenter listener in app.py which does the same thing safely.
        svg_content.append(
